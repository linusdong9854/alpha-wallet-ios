...
class SelectAssetViewController: UIViewController {
    ...
    init(sessions: ServerDictionary<WalletSession>, tokenCollection: TokenCollection, assetDefinitionStore: AssetDefinitionStore, filterTokensCoordinator: FilterTokensCoordinator) {
    ...
    private func handleTokenCollectionUpdates() {
        tokenCollection.subscribe { [weak self] result in
            ...
            case .success(let viewModel):
                strongSelf.viewModel = .init(tokensViewModel: viewModel, filterTokensCoordinator: strongSelf.filterTokensCoordinator)
