...
protocol ConfirmationTableHeaderViewDelegate: class {
    func headerView(_ header: ConfirmationTableHeaderView, didSelectExpand sender: UIButton, section: Int)
}

class ConfirmationTableHeaderView: UITableViewHeaderFooterView {
    ...
    private var viewModel: ConfirmationTableHeaderViewViewModel?

    weak var delegate: ConfirmationTableHeaderViewDelegate?
    ...
    func configure(viewModel: ConfirmationTableHeaderViewViewModel) {
