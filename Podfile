...
target 'AlphaWallet' do
  ...
  pod 'QRCodeReaderViewController', :git=>'https://github.com/vladyslav-iosdev/QRCodeReaderViewController.git',:branch=>'#1814', :commit=>'72f2eeee325327df16530e6e6d6738a890458a5d'
